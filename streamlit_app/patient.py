...
# Set page config
st.set_page_config(
    page_title="Patient Activity Recognition",
    page_icon="🏃‍♂️",
    layout="wide",
...
with st.expander("📊 Live Sensor Feed Simulation", expanded=True):
    st.markdown("**Patient Activity Detection**")
    st.markdown(
        """
...
st.markdown("""
    ...
    <div class="header-container">
        <div>
            <div class="header-title">Patient ACTIVITY RECOGNITION DASHBOARD</div>
...
st.markdown(
    ...
    <div class="footer">
        Developed by <strong>ANKIT KUMAR MISHRA</strong>
    </div>
    """,
    unsafe_allow_html=True
)
